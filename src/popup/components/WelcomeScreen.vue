<template>
  ...
  >
    <div class="spark-icon-wrapper">
      ...
      <h2 class="castor-name" :class="{ 'fade-out': startAnimation }">Castor</h2>
    </div>
...
onMounted(() => {
  // Start the main animation sequence after a 2-second delay
  setTimeout(() => {
    startAnimation.value = true;
  }, 2000);

  // Show the main content after the expansion animation is complete
  setTimeout(() => {
    showContent.value = true;
  }, 2800); // 2000ms delay + 800ms for animation
});
</script>
...
.spark-icon {
  ...
  animation: pulse-inner 2s ease-in-out;
}
